...
const Hero = () => {
  return (
    <div className='bg-hero-image xl:min-h-screen 2xl:min-h-max bg-cover bg-no-repeat bg-center items-center justify-center flex flex-col'>
        <Header/>
        <div className="container mx-auto flex flex-col items-center justify-center">
            ...
            <CustomButton buttonText='Get started' myClass="!bg-deep-blue !text-white hover:!text-deep-blue hover:!bg-white lg:mb-[200px] mb-14" />
        </div>
    </div>
  )
}
